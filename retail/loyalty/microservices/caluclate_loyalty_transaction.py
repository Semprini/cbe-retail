...
if __name__ == "__main__":
    #test
    #props = pika.BasicProperties(headers = {'foo':'a'})
    #callback(None, None, props, test_json)

    connection = pika.BlockingConnection(pika.ConnectionParameters(host=QUEUE_HOST))
    try:
       queue_setup().start_consuming()
