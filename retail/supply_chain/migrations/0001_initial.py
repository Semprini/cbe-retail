...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='purchaseorderacknowledgements',
            unique_together=set([('message_date_time', 'purchase_order', 'supplier', 'delivery_store')]),
        ),
        migrations.AlterUniqueTogether(
            name='purchaseorder',
            unique_together=set([('purchase_order_reference', 'supplier', 'delivery_store', 'despatched_date_time')]),
        ),
        migrations.AlterUniqueTogether(
            name='poexpecteddeliverydate',
            unique_together=set([('purchase_order', 'delivery_store', 'supplier')]),
        ),
        migrations.AlterUniqueTogether(
            name='asns',
            unique_together=set([('asn_reference', 'supplier')]),
        ),
    ]
